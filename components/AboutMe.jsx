...
export default function AboutMe() {
  return (
    <section id='aboutMe' className='relative flex flex-col h-auto justify-between'>
          ...
          {/* Grid Container */}
          <div className='flex flex-col lg:grid lg:grid-cols-12 lg:grid-rows-5 lg:justify-center lg:items-center mx-12 lg:m-24'>
            {/* Grid Item 1 */}
            ...
            {/* Grid Item 3 */}
            <div className='mt-12 mb-12 mx-auto lg:mb-0 order-1 lg:col-start-5 lg:col-span-4 lg:row-start-2 lg:row-span-4'>
              <Image
                src={meImage}
                alt='me'
                height={100}
